...
#define FIX 6
#define SHELLCODE_LEN 49 + 59      + 5 +FIX
#define JMP_INDEX 100 +FIX
#define DECREL_DATA_INDEX 62+FIX
#define STRSIZE_INDEX 39 +FIX
#define RELCALL_INDEX 43 +FIX
unsigned char shellcode32[SHELLCODE_LEN] = "";
